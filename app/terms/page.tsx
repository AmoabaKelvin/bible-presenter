...
export const metadata: Metadata = {
  title: "Terms of Use | FlowCast",
  description: "Terms of Use for FlowCast.",
}
    ...
    <main className="legal-page">
      <div className="legal-shell">
        ...
        <section className="legal-content">
          <p>
            These Terms of Use govern your use of FlowCast, a personal presentation tool for
            scripture, notes, media, and music playback controls.
          </p>

          <h2>Use of the App</h2>
          <p>
            You may use FlowCast for personal presentation workflows. You are responsible for how you
            use the app, the content you display, and the music or media you choose to play.
          </p>

          <h2>Connected Services</h2>
          <p>
            FlowCast can connect to Google/YouTube and Spotify through OAuth. By connecting an
          ...
          <p>
            Your use of YouTube and Spotify through FlowCast is also subject to those services&apos;
          ...
          <p>
            ...
            FlowCast. Playlist, track, video, album, artist, and account data remain governed by the
          ...
          <h2>No Warranty</h2>
          <p>
            FlowCast is provided as-is without warranties of any kind. The app owner does not
          ...
          <h2>Changes</h2>
          <p>
            These terms may be updated as the app changes. Continued use of FlowCast after updates
